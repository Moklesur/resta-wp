 ...
 * @since 1.0.0
 */
class resta_video_with_text extends Widget_Base
{
    ...
    {
        return __('Video With Text', 'resta');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => __( 'Discover Our Story!', 'resta' )
            ]
        );
        // Title
        $this->add_control(
        ...
        <section class="video_with_text">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <aside class="col-lg-6 col-md-6 col-sm-12 <?php echo esc_html($right_class); ?>">
                        <article class="video-wrap">
                            <figure class="promo-video poster-1">
                                <img src="<?php echo esc_url( $settings['poster_image_one']['url'] ); ?>" alt="poster">
                                <a data-fancybox href="<?php echo esc_url( $settings['video_url']['url'] ); ?>?autoplay=1" class="play-btn"> <i
                                            class="icofont-play"></i></a>
                                <span class="overlay"></span>
                            </figure>
                            <?php
                            if (!empty($settings['poster_image_two']['url'])):
                            ?>
                            <figure class="poster-2">
                                <img src="<?php echo esc_url( $settings['poster_image_two']['url'] ); ?>" alt="poster">
                            </figure>
                                <?php
                            endif;
                                ?>
...
Plugin::instance()->widgets_manager->register_widget_type(new resta_video_with_text());